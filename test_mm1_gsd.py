...
if __name__ == "__main__":
    ...
    plt.plot(x_axis, GSD_V1_lp_win, label=r'$\mathrm{GSD}$', linestyle='--', linewidth=1.5)
    ...
    plt.plot(x_axis, GSD_V2_lp_win, label=r'$\widetilde{\mathrm{GSD}}$', linestyle='--', linewidth=1.5)
