...
if __name__ == "__main__":
    ...
    print(f"rho_1: {(lmd_1 / mu):.2f}, rho_2: {(lmd_2 / mu):.2f}")
    ...
    # ===================== PLOTS =====================
    folder = "./data/test_mm1_sim/" + f"lmd1_{lmd_1}_lmd2_{lmd_2}_mu_{mu}/"
    ...
    # plt.plot(x_axis, GSD_V1_win,    label=r'$\mathrm{GSD}_{full}$', linewidth=1.5)
    plt.plot(x_axis, GSD_V1_lp_win, label=r'$\mathrm{GSD}$', linestyle='--', linewidth=1.5, color=colors[0])
    ...
    plt.figure(figsize=(8, 5))
    # plt.plot(x_axis, GSD_V2_win,    label=r'$\widetilde{\mathrm{GSD}}$_{full}', linewidth=1.5)
    plt.plot(x_axis, GSD_V2_lp_win, label=r'$\widetilde{\mathrm{GSD}}$', linestyle='--', linewidth=1.5, color=colors[1])
    ...
    plt.tight_layout()
    # Optional: save to PDF
    filename2 = f"gsd_V2_lmd1_{lmd_1}_lmd2_{lmd_2}_mu_{mu}.pdf"
